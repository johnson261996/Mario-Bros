package com.johnson.mariobros.Sprites;
...
/**
 * Created by johnson mendonca on 06-Jan-17.
 */
...
public class Mario extends Sprite {
    ...
    public  Mario( PlayScreen screen){
        ...
        manager.load("audio/sounds/Big Jump.wav", Sound.class);
    ...
    public void jump(){
        if ( currentState != State.JUMPING ) {
            ...
            manager.get("audio/sounds/Big Jump.wav", Sound.class).play();
        }
    }
